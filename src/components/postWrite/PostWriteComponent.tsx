				...
				>
					<ClickAwayListener onClickAway={this.handleCloseMenu}>
						<Grow in={menuOpen}>
							<Paper>
								<MenuList role="menu">
									<MenuItem onClick={this.handleToggleComments}
											  style={{fontSize: "14px"}}>{!this.state.disableComments ? "Disable comments" : "Enable comments"} </MenuItem>
									<MenuItem onClick={this.handleToggleSharing}
											  style={{fontSize: "14px"}}>{!this.state.disableSharing ? "Disable sharing" : "Enable sharing"}</MenuItem>
								</MenuList>
							</Paper>
						</Grow>
					</ClickAwayListener>
									...
									<div style={{
										...
										<div style={{
											...
											<div style={{flexDirection: "row", display: "flex"}}>
												<div onClick={this.handleOpenGallery} style={{
													outline: "none",
													width: "48px",
													zIndex: 0,
													overflow: "hidden",
